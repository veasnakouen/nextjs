    ...
    <>
      <div className="relative">
        <div
          ...
          } cursor-pointer fixed  w-14 h-14 lg:w-24 lg:h-14 bg-[#48AFDE]  flex justify-center items-center rounded-br-3xl`}
        >
          <div
      ...
      >
        <div className="relative">
          <div className="z-20 absolute transform-gpu ease-in-out duration-500 transition-100 -translate-x-none -translate-y-none opacity-100 bg-[#223740] bg-opacity-95 w-full flex flex-col h-screen lg:flex-col items-center justify-center">
